...
np.save("/lotterlab/users/vmishra/brca_embeddings_virchow.npy", brca_embeddings)
np.save("/lotterlab/users/vmishra/luad_embeddings_virchow.npy", luad_embeddings)
np.save("/lotterlab/users/vmishra/lusc_embeddings_virchow.npy", lusc_embeddings)
np.save("/lotterlab/users/vmishra/coad_embeddings_virchow.npy", coad_embeddings)
