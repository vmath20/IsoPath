...
np.save("brca_embeddings_resnet.npy", brca_embeddings)
np.save("luad_embeddings_resnet.npy", luad_embeddings)
np.save("lusc_embeddings_resnet.npy", lusc_embeddings)
np.save("coad_embeddings_resnet.npy", coad_embeddings)
